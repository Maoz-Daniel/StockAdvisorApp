...
class BuyOrderWindow(QMainWindow):
    def __init__(self, username="Guest"):
        ...
        self.header_frame.setStyleSheet("""
            QFrame {
                background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #1D7874, stop:1 #2EAF7D);
                border-radius: 12px;
                border: none;
                padding: 5px;
            }
        ...
        subtitle_label = QLabel(f"Manage your buy orders - {self.username}")
        ...
        self.buy_button.setStyleSheet("""
            ...
            QPushButton:hover {
                background-color: #3CC990;
            }
        """)
        self.buy_button.clicked.connect(self.process_buy_order)
    ...
    def process_buy_order(self):
        ...
        confirmation_msg = f"📈 You are buying {quantity} shares of {stock} at {price} per unit using {order_type}."
...
if __name__ == "__main__":
    ...
    window = BuyOrderWindow("John Doe")
    window.show()
